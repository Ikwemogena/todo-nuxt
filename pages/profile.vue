<!-- <template>
    <div class="container">
      ...
      <div class="user-info">
        <div class="user-avatar">
          ...
          <!-- <img :src="user.avatar" :alt="user.email" class="w-24 h-24 rounded-full"> 
        </div>
      ...
      <button class="logout-btn" @click.prevent="logout">Sign out</button>
    </div>
  </template>
  ...
  <script setup>
  // import { useRouter, definePageMeta } from 'vitepress';
